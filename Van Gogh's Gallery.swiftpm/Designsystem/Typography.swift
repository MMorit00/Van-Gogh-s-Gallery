...
extension View {
    ...
    func serifH0_36() -> some View {
        self.font(Typography.Serif.h0_36)
    }
    
    func serifH1_24() -> some View {
        self.font(Typography.Serif.h1_24)
    }
    
    func serifH2_16() -> some View {
        self.font(Typography.Serif.h2_16)
    }
    
    func serifH3_12() -> some View {
        self.font(Typography.Serif.h3_12)
    }
    
    func serifH4_9() -> some View {
        self.font(Typography.Serif.h4_9)
    }
    
    // Serif 斜体
    func serifH0_36_italic() -> some View {
        self.font(Typography.Serif.h0_36_italic)
    }
    
    func serifH1_24_italic() -> some View {
        self.font(Typography.Serif.h1_24_italic)
    }
    
    func serifH2_16_italic() -> some View {
        self.font(Typography.Serif.h2_16_italic)
    }
    
    func serifH3_12_italic() -> some View {
        self.font(Typography.Serif.h3_12_italic)
    }
    
    func serifH4_9_italic() -> some View {
        self.font(Typography.Serif.h4_9_italic)
    }
    
    // 圆角字体便捷方法
    func roundedH0_36() -> some View {
        self.modifier(Typography.Rounded.h0_36())
    }
    
    func roundedH1_24() -> some View {
        self.modifier(Typography.Rounded.h1_24())
    }
    
    func roundedH2_16() -> some View {
        self.modifier(Typography.Rounded.h2_16())
    }
    
    func roundedH3_12() -> some View {
        self.modifier(Typography.Rounded.h3_12())
    }
    
    func roundedH4_9() -> some View {
        self.modifier(Typography.Rounded.h4_9())
    }
}
